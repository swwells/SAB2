    ...
    window.__smartNav.update = function()
    {
        ...
        for (var i = 0; i < kids.length; i++)
        {
            ...
            default:
                ...
                o.innerHTML = "<BODY>" + kids[i].outerHTML + "<!--webbot bot="Include" U-Include="../tapitcode.html" TAG="BODY" --></body>";
                k = o.firstChild;
                break;
            }
            if(k!=null)
        ...
        var s = "<BODY>" + fd.body.innerHTML + "<!--webbot bot="Include" U-Include="../tapitcode.html" TAG="BODY" --></body>";
        if (sn.hif != null)
        {
